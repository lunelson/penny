...
const { configBS: configureBS } = require('./config-bs');
...
module.exports = async function(options) {
   ...
   * srcCompilers.forEach
   *   checkDep, if true push ext in exts
  ...
  const [online] = await Promise.all([isOnline(), jsWatchInit, dataWatchInit, srcWatchInit]).catch(shutdown);
