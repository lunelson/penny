...
/*
  ABOUT SRC EXTENSIONS
  - eventually, support some processing of native types too
  - .scss, .styl, .css || .pug, .ejs, .html || .ts, .js
*/
...
module.exports = function(srcDir, options) {
  ...
  if (isDev) {
    ...
    bsync.init({
      ...
      // FLAGS (doesn't work): https://github.com/BrowserSync/browser-sync/releases/tag/v2.17.0
      // browser: [
      //   {
      //     app: [
      //       'google chrome',
