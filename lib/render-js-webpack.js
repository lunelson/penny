...
/*
  NB: NO CONCURRENT COMPILING
  ...shouldn't bite here; but in theory the compiler needs a way to check its own status,
  and wait for its last compilation to resolve before running another one
