...
const mdLogger = eazyLevels.reduce((obj, level) => { obj[level] = function(str){eazyLogger[level](`[{blue:md}] ${str}`);}; return obj; }, {});

module.exports = { eazyLogger, pennyLogger, webpackLogger, sassLogger, pugLogger, mdLogger };
