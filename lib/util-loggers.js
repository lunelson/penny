...
module.exports = {
  ...
  dataLogger: ez.Logger({ ...config, prefix: '[{orange:data}]' }),
  htmlLogger: ez.Logger({ ...config, prefix: '[{red:html}]' }),
  cssLogger: ez.Logger({ ...config, prefix: '[{magenta:css}]' }),
  jsLogger: ez.Logger({ ...config, prefix: '[{cyan:webpack}]' }),
