...
class SrcCompiler {
  constructor(absFile) {
    this.srcFile = absFile;
  }
}

class CssCompiler extends SrcCompiler {}
class HtmlCompiler extends SrcCompiler {}

class SassCompiler extends CssCompiler {}
class ScssCompiler extends CssCompiler {}
class StylCompiler extends CssCompiler {}

class PugCompiler extends HtmlCompiler {}
class NjkCompiler extends HtmlCompiler {}
class EjsCompiler extends HtmlCompiler {}
class MdCompiler extends HtmlCompiler {}

function watchSrc(options, onEvent) {
      ...
      const watcher = chokidar
        ...
        .on('all', (fileEvent, relFile) => {
          ...
          if (isEntry && !isHidden && !currentErr) {
            ...
            } else if (!srcCompilers.has(absFile)) {
              try {
                /**
                ...
                if (validSrc) {
                  ...
                  srcCompilers.set(absFile, new SrcCompiler(absFile));
